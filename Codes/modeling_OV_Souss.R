...
fit.xgbAll = get(load(file = "fit_xgbAll.Rdata"))
...
save(knn_default, file = "fit_knn.Rdata")
...
writeRaster(r_ave_yes,filename="Prediction_floods_nnet.tif", format="GTiff", overwrite=TRUE) 
writeRaster(r_ave_no,filename="Prediction_non_floods_nnet.tif", format="GTiff", overwrite=TRUE) 
