...
ggrocs <- function(rocs, breaks = seq(0,1,0.1), legendTitel = "Legend") {
  if (length(rocs) == 0) {
    ...
    rocPlot <- ggplot(RocVals, aes(x = fpr, y = tpr, colour = names), size=2) +
      ...
      theme_bw() + 
      coord_equal() +
      annotate("text",x = 0.175, y = 0.8, vjust = 0, hjust = 0,size = 3,label= "AUC(RF) = 0.967") + 
      annotate("text",x = 0.175, y = 0.75, vjust = 0, hjust = 0,size = 3,label= "AUC(RF_TR) = 0.967") + 
      annotate("text",x = 0.175, y = 0.7, vjust = 0, hjust = 0,size = 3,label= "AUC(RF_SE) = 0.930") + 
      annotate("text",x = 0.175, y = 0.65, vjust = 0, hjust = 0,size = 3,label= "AUC(RF_TR_SE) = 0.981") + 
      annotate("text",x = 0.175, y = 0.6, vjust = 0, hjust = 0,size = 3,label= "AUC(XGB) = 0.959") + 
      annotate("text",x = 0.175, y = 0.55, vjust = 0, hjust = 0,size = 3,label= "AUC(XGB_TR) = 0.941") + 
      annotate("text",x = 0.175, y = 0.5, vjust = 0, hjust = 0,size = 3,label= "AUC(XGB_SE) = 0.972") + 
      annotate("text",x = 0.175, y = 0.45, vjust = 0, hjust = 0,size = 3,label= " AUC(XGB)_TR_SE = 0.944") + 
      annotate("text",x = 0.175, y = 0.4, vjust = 0, hjust = 0,size = 3,label= "AUC(KNN) = 0.946") + 
      annotate("text",x = 0.175, y = 0.35, vjust = 0, hjust = 0,size = 3,label= "AUC(KNN_TR) = 0.951") + 
      annotate("text",x = 0.175, y = 0.3, vjust = 0, hjust = 0,size = 3,label= "AUC(KNN_SE) = 0.986") + 
      annotate("text",x = 0.175, y = 0.25, vjust = 0, hjust = 0,size = 3,label= "AUC(KNN_TR_SE) = 0.986") + 
      annotate("text",x = 0.175, y = 0.2, vjust = 0, hjust = 0,size = 3,label= "AUC(NNET) = 0.933") + 
      annotate("text",x = 0.175, y = 0.15, vjust = 0, hjust = 0,size = 3,label= "AUC(NNET_TR) = 0.959") + 
      annotate("text",x = 0.175, y = 0.1, vjust = 0, hjust = 0,size = 3,label= "AUC(NNET_SE) = 0.954") + 
      annotate("text",x = 0.175, y = 0.05, vjust = 0, hjust = 0,size = 3,label= "AUC(NNET_TR_SE) = 0.954") +
...
jpeg("ROC_models.png", width =1200, height = 900)
ggrocs(list_roc)
dev.off()
